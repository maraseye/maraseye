...
LOGIN = os.environ.get("GITHUB_LOGIN", "maraseye")
...
PROFILE_FIELDS = [
    ...
    ("Focus", "full-stack & devops enthusiast"),
    ("Stack.Frontend", "react, typescript, html, css"),
    ("Stack.Backend", "node.js, fastapi, laravel, java"),
    ("Stack.DevOps", "docker, traefik, keycloak, rabbitmq"),
    ("Stack.Database", "postgresql, mysql, redis"),
    ("Stack.Tools", "git, github, gitlab, vscode, postman"),
    ("Environment", "linux, git, docker, vscode"),
    ("Interests", "scalable systems & clean architecture"),
    ("Contact.GitHub", f"github.com/{LOGIN}"),
    ("Contact.LinkedIn", "linkedin.com/in/maraseye"),
    ("Contact.Portfolio", "portfolio-sals.vercel.app"),
]
